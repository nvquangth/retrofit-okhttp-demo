...
import com.nvquang.retrofitokhttpdemo.data.source.remote.middleware.InterceptorImpl;
import com.nvquang.retrofitokhttpdemo.data.source.remote.middleware.RxErrorHandlingCallAdapterFactory;
...
public class NetworkModule {
    ...
    public Retrofit provideRetrofit(Gson gson, OkHttpClient okHttpClient) {
        return new Retrofit.Builder().baseUrl(Constant.END_POINT)
    ...
    @AppScope
    @Provides
    public StackOverflowAPI provideNameApi(Retrofit retrofit) {
